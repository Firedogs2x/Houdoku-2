...
export class ExtensionClient extends ExtensionClientAbstract {
  ...
  override getDirectory: GetDirectoryFunc = (page: number, _filterValues: FilterValues) => {
  ...
  override getSearch: GetSearchFunc = (text: string, page: number, _filterValues: FilterValues) => {
  ...
  override setSettings: SetSettingsFunc = (_newSettings: { [key: string]: any }) => {};
