import { LanguageKey, SeriesStatus } from '@houdoku/common';
...
if (CLEAR_SETTINGS_ON_STARTUP) {
  console.warn('CLEARING ALL STORED SETTINGS - DEVELOPMENT MODE');
...
export const chapterFolderState = atm<string>(GeneralSetting.ChapterFolder);
export const chapterNameState = atm<string>(GeneralSetting.ChapterName);
export const additionalFolder1State = atm<string>(GeneralSetting.AdditionalFolder1);
export const additionalFolder2State = atm<string>(GeneralSetting.AdditionalFolder2);
